...
try {
    ...
    print 'Unexpected ' . $e::class . ' exception: ' . $e->getMessage();
}

print PHP_EOL . 'EXCEPTION IF ORIGIN IS THE SAME AS DESTINY:' . PHP_EOL . PHP_EOL;
try {
    $paths = $graph->getShortestPath("Madrid", "Madrid");
